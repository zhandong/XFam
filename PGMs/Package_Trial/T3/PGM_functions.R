...
#
#
LGM.select.generic <- function(X, method="LPGM", link="poisson", N=100,beta=0.05, lmin = 0.01, nlams=20, lambda.path=NULL ,parallel=T,nCpus=4){
	require('huge')
	require('glmnet')
...
# ---------------------------------------------------------------------------------------------------------------------------------------------------
myglmnet.max <-function(X, link ="poisson",delta=0.01){
	minlambda =0;
